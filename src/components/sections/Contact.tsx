      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          <a
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 min-h-[44px] rounded-lg text-sm font-medium text-[#A1A1AA] transition-all duration-200 hover:text-[#A3E635]"
        ...
        {/* Info adicional — location y phone */}
        <div
